  ...
  if (requests.length === 0) {
    return (
      <div className="py-12 text-center bg-slate-50/50 rounded-[2rem] border border-dashed border-slate-200">
        ...
        <p className="text-slate-300 text-xs mt-1">All caught up! No time corrections need review.</p>
      </div>
    )
  }
      ...
      {requests.map((request) => {
        ...
        return (
          ...
          >
            ...
            <div className="mb-6">
              <h4 className="text-sm font-black text-indigo-600 uppercase tracking-widest mb-1.5 flex items-center">
